...
- Wskaźnik postępu edycji fiszek (np. "5/20 zaakceptowanych")
...
- System wyświetla wskaźnik postępu (np. "5/20 zaakceptowanych")
...
- Po zobaczeniu tyłu, użytkownik może ocenić stopień zapamiętania materiału (np. "Trudne", "Dobre", "Łatwe")
...
### US-018 Informacje pomocnicze o tworzeniu fiszek
Jako użytkownik, chcę otrzymać wskazówki dotyczące typów tekstów, które dają najlepsze rezultaty przy generowaniu fiszek.

Kryteria akceptacji:
- System wyświetla informacje pomocnicze przy formularzu wprowadzania tekstu
- Wskazówki zawierają przykłady dobrych typów tekstów
- Wskazówki zawierają informację o obsługiwanych językach
- Wskazówki są zwięzłe i łatwe do zrozumienia
- Użytkownik może zwinąć/rozwinąć sekcję ze wskazówkami

### US-019 Zbieranie feedbacku o jakości generowania
Jako użytkownik, chcę mieć możliwość przekazania opinii o jakości wygenerowanych fiszek.

Kryteria akceptacji:
- System udostępnia opcję oceny jakości wygenerowanych fiszek (np. skala 1-5)
- Użytkownik może dodać komentarz do swojej oceny
- System potwierdza przyjęcie opinii
- Zebrane opinie są przechowywane w systemie dla celów analitycznych
